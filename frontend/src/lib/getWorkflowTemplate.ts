...
export async function getWorkflowTemplate(template_name: string): Promise<{ workflowTemplate: WorkflowTemplate }> {
    const variables = {
        name: template_name
    };
...
export async function getWorkflowTemplateFromDryRun(template_name: string): Promise< { workflowTemplate: WorkflowTemplateFromDryRun }> {
    const variables = {
